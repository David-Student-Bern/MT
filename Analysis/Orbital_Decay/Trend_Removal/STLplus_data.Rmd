...
lines(data_groups$`2023-05-01_to_2023-10-01`$time, recreated, col = "red", lwd = 2)
...
plot(periods_STL, spec_STL$spec, type = "l",
     ...
     log = "x",
     xlab = "Period (days)", ylab = "Spectral Density",
     main = "Periodogram - STL",
     xlim = c(1e-2, 10)
)

# --- Periodogram for 'recreated' ---
...
plot(periods_recreated, spec_recreated$spec, type = "l",
     ...
     log = "x",
     xlab = "Period (days)", ylab = "Spectral Density",
     main = "Periodogram - Recreated",
     xlim = c(1e-2, 10)
)

# --- Periodogram for 'diff' ---
...
plot(periods_diff, spec_diff$spec, type = "l",
     ...
     log = "x",
     xlab = "Period (days)", ylab = "Spectral Density",
     main = "Periodogram - Difference",
     xlim = c(1e-2, 10)
)

# --- Periodogram for 'Decay - STL' ---
...
# Plot the difference over time
plot(data_groups$`2023-05-01_to_2023-10-01`$time, df, type = "l", col = "blue", lwd = 2,
     main = "Difference: Original - Recreated",
     xlab = "time", ylab = "Difference")
